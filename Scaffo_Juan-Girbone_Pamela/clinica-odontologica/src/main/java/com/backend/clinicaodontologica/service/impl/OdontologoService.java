...
public class OdontologoService implements IOdontologoService {
    ...
    public OdontologoSalidaDto modificarOdontologo(OdontologoEntradaDto odontologoEntradaDto, Long id) throws ResourceNotFoundException {
        ...
        if (odontologoOptional.isPresent()) {
            ...
            odontologo.setNombre(odontologoEntradaDto.getNombre());
            odontologo.setApellido(odontologoEntradaDto.getApellido());
            odontologo.setMatricula(odontologoEntradaDto.getMatricula());
